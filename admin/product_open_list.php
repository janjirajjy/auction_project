...
while($row = mysqli_fetch_array($result)) { 
  ...
  //แก้ไขข้อมูล
  echo "<td align='center'>
  <a href='product.php?ID=$row[auction_id]&act=openedit' class='btn btn-warning btn-xs'>edit</a></td> ";
  
  //ลบข้อมูล
  echo "<td align='center'>
  <a href='product_open_del_db.php?aid=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>del</a></td> ";
