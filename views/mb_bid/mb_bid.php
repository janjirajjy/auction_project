...
?>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default card-view">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h5 class="control-label mb-10" for="exampleCountry">ประวัติการเข้าประมูล</h5>
                                    </div>
    ...
    <!-- Data table JavaScript -->
    <script src="../../endors/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
