...
WHERE a.productstatus_id IN (2,3) AND p.product_customerid='$cus_cus_email'
ORDER BY a.auction_id DESC" 
or die("Error:" . mysqli_error());
$resultteble = mysqli_query($condb, $query); 
?>
<!-- /ตารางรายละเอีอดสินค้า -->
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">สิ้นค้ารอจัดส่ง</h6>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-wrap">
                                        <div class="table-responsive">
                                            <table id='example' class='display table table-bordered table-hover  pb-30 ">
                                            <thead>
                                                <tr class=' danger'>
                                                <th width='5%'>รหัส</th>
                                                <th width='10%'>ภาพ</th>
                                                <th width='30%'>ชื่อสินต่า</th>
                                                <th width='20%'>ผู้ชนะประมูล</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                $i=1;
                                            while($row = mysqli_fetch_array($resultteble)) { 
                                                echo "<tr>";
                                                echo "<td >" .$i .'.'."</td> "; 
                                                echo "<td>"."<img src='../../".$row['product_photo']."' width='50%'>"."</td>";
                                                echo "<td>" .$row["product_name"].' จำนวน '.$row["auction_amount"].' '.$row["unit_detail"]
                                                .'<br>'
                                                .'<font color="blue">'
                                                .'เปิด '
