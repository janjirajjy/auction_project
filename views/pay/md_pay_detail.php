                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h5 class="control-label mb-10" for="exampleCountry">ข้อมูลการชำระเงินค่าสินค้า</h5>
                                </div>
...
<br>
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
         <input type="text" name="tracking_id" required placeholder="รหัสพัดุ/ems" value="<?php echo $rowsl['tracking_id'];?>">
      </div>
    </div>
     <div class="form-group">
      <div class="col-sm-2">
