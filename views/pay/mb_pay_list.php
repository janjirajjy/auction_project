            ...
            <div class="mobile-only-nav pull-right">
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav" id="navlink" style="float:right">
                        <li><a href="profile.php">จัดการโปรไฟล</a></li>
                        <li><a href="../about.php">จัดการบัญชี</a></li>
                        <li><a href="../about.php">รายการสินค้า</a></li>
                        <li><a href="../about.php">ประวัติการประมูล</a></li>
                        <li><a href="../cart.php">รถเข็น</a></li>
                        <li><a href="../about.php">สินค้ารอจัดส่ง</a></li>
...
WHERE a.auction_id=$_GET[auction_id]
...
?>
            ...
            <div style="background-color: #c9ecf2; padding: 20px;">
                ...
                <form class="form-horizontal" method="post" action="mb_pay_save_postcode.php"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="tracking_id" required placeholder="รหัสพัดุ/ems"
                                value="<?php echo $rowsl['tracking_id'];?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-5">
                            <input type="hidden" value="<?php echo $rowsl['trans_price'];?>" name="trans_price">
                            <input type="hidden" name="auction_id" value="<?php echo $rowsl['auction_id'];?>">
                            <?php $dos = $_GET['do'];
         if($dos=='payformok'){

         }else{ ?>
                            <button type="submit" class="btn btn-primary"
                                onclick="return confirm('ยืนยัน');">บันทึก</button>
                            <?php } ?>
                        </div>
                    </div>
                </form>
