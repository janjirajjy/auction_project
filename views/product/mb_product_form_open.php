...
<form action="mb_product_form_open_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
    <input type="hidden" name="auction_customerid" value="<?php echo $cus_cus_email;?>">
