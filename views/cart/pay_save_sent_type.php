...
";
	...
	echo "window.location = 'cart.php?act=upload&auction_id=$auction_id&s=$send_id&sr=$send_rate&pt=$totalprice&do=uploadslip'; ";
	echo "</script>";
	}else{
	echo "<script type='text/javascript'>";
	//echo "alert('Error!!');";
	echo "window.location = 'cart.php?act=upload&auction_id=$auction_id'; ";
	echo "</script>";
}
?>
