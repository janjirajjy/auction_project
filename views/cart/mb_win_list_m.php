...
$i=1;
            while($row = mysqli_fetch_array($result)) { 
                    ...
                    echo "<br>";
  if($st==1){
      echo "<a href='cart.php?id=$row[auction_id]&act=pay&p=$row[product_price_bid]&do=payform' class='btn btn-warning btn-xs'>ชำระเงิน</a>";
  }else{

     echo "<a href='cart.php?auction_id=$row[auction_id]&act=showslip&p=$row[product_price_bid]&do=payform' class='btn btn-success btn-xs' >การชำระเงิน</a>";
 ...
 echo "</td> "; 
  ...
  <a href='../../bid_history.php?id=$row[auction_id]' class='btn btn-info btn-xs' target='_blank'>VIEW</a></td> ";
