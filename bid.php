            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" name=""
                        value="<?php echo date('d/m/Y',strtotime($row_item['auction_startdate']));?>" readonly>
                    <br><br>
                    วันจบประมูล :
                    <input type="text" name=""
                        value="<?php echo date('d/m/Y',strtotime($row_item['auction_enddate']));?>" readonly>
                    <br><br>
                    เวลาปิดประมูล :
                    <input type="text" name=""
                        value="<?php echo date('H:i:s',strtotime($row_item['auction_endtime']));?>" readonly>
